...
#define DEVICE_COMM_INTERFACE_COLL_DECLARATION__VOID                                    \
                                                                                        \
virtual ccl::device_communicator::coll_request_t allgatherv(const void* send_buf,       \
                                                            size_t send_count, \
                                                            void* recv_buf,    \
...
virtual ccl::device_communicator::coll_request_t allgatherv(const void* send_buf,       \
                                                            ...
                                                            const ccl::vector_class<ccl::event>& deps = {}) = 0;  \
                                                                                                        \
virtual ccl::device_communicator::coll_request_t allreduce(const void* send_buf,  \
                                                            void* recv_buf, \
                                                            size_t count,   \
                                                            ccl_datatype_t dtype, \
                                                            ccl::reduction reduction,   \
                                                            ...
                                                            const ccl::vector_class<ccl::event>& deps = {}) = 0;   \
                                                                                        \
virtual ccl::device_communicator::coll_request_t alltoall(const void* send_buf,     \
                                                           void* recv_buf,  \
                                                           size_t count,    \
                                                           ccl_datatype_t dtype,  \
                                                           ...
                                                           ccl::stream::impl_value_t& op_stream,    \
                                                           const ccl::vector_class<ccl::event>& deps = {}) = 0;   \
virtual ccl::device_communicator::coll_request_t alltoall(const ccl::vector_class<void*>& send_buf,      \
                       ...
                       const ccl::vector_class<ccl::event>& deps = {}) = 0;   \
                                                                                                    \
virtual ccl::device_communicator::coll_request_t alltoallv(const void* send_buf,    \
                        ...
                        const ccl::vector_class<ccl::event>& deps = {}) = 0;   \
                                                                                        \
virtual ccl::device_communicator::coll_request_t alltoallv(const ccl::vector_class<void*>& send_bufs,    \
                        const ccl::vector_class<size_t>& send_counts,    \
                        const ccl::vector_class<void*>& recv_bufs,   \
                        const ccl::vector_class<size_t>& recv_counts,\
                        ccl_datatype_t dtype, \
                        ...
                        const ccl::vector_class<ccl::event>& deps = {}) = 0;  \
    \
virtual ccl::device_communicator::coll_request_t bcast(void* buf,   \
                    size_t count,   \
                    ccl_datatype_t dtype, \
                    size_t root,    \
                    ...
                    const ccl::vector_class<ccl::event>& deps = {}) = 0;  \
                                                                                        \
virtual ccl::device_communicator::coll_request_t reduce(const void* send_buf,                  \
                                                 void* recv_buf,                        \
                                                 size_t count,                          \
                                                 ccl_datatype_t dtype,                  \
                                                 ccl::reduction reduction,              \
                                                 ...
                                                 const ccl::vector_class<ccl::event>& deps = {}) = 0; \
                                                                                            \
virtual ccl::device_communicator::coll_request_t reduce_scatter(const void* send_buf,       \
                             void* recv_buf,   \
                             size_t recv_count, \
                             ccl_datatype_t dtype,  \
                             ccl::reduction reduction,  \
...
#define DEVICE_COMM_INTERFACE_SPARSE_DECLARATION__VOID                                            \
                                                                                           \
virtual ccl::device_communicator::coll_request_t                                                  \
...
#define DEVICE_COMM_INTERFACE_COLL_DECLARATION(type)                                           \
                                                                                        \
virtual ccl::device_communicator::coll_request_t allgatherv(const type* send_buf,              \
                                                     size_t send_count,                 \
                                                     type* recv_buf,                    \
                                                     const size_t* recv_counts,         \
                                                     const ccl::allgatherv_attr_t& attr,        \
                                                     ...
                                                     const ccl::vector_class<ccl::event>& deps = {}) = 0;  \
                                                                                        \
virtual ccl::device_communicator::coll_request_t allreduce(const type* send_buf,               \
                                                    type* recv_buf,                     \
                                                    size_t count,                       \
                                                    ccl::reduction reduction,           \
                                                    ...
                                                    const ccl::vector_class<ccl::event>& deps = {}) = 0;   \
                                                                                        \
virtual ccl::device_communicator::coll_request_t alltoall(const type* send_buf,                \
                                                   type* recv_buf,                      \
                                                   size_t count,                        \
                                                   ...
                                                   const ccl::vector_class<ccl::event>& deps = {}) = 0;    \
                                                                                        \
virtual ccl::device_communicator::coll_request_t alltoallv(const type* send_buf,               \
                                                    const size_t* send_counts,          \
                                                    type* recv_buf,                     \
                                                    const size_t* recv_counts,          \
                                                    const ccl::alltoallv_attr_t& attr,         \
                                                    ...
                                                    const ccl::vector_class<ccl::event>& deps = {}) = 0;   \
                                                                                        \
virtual ccl::device_communicator::coll_request_t bcast(type* buf,                              \
                                                size_t count,                           \
                                                size_t root,                            \
                                                ...
                                                const ccl::vector_class<ccl::event>& deps = {}) = 0;       \
                                                                                        \
virtual ccl::device_communicator::coll_request_t reduce(const type* send_buf,                  \
                                                 type* recv_buf,                        \
                                                 size_t count,                          \
                                                 ccl::reduction reduction,              \
                                                 size_t root,                           \
...
#define DEVICE_COMM_INTERFACE_COLL_DEFINITION__VOID                                            \
                                                                                        \
ccl::device_communicator::coll_request_t allgatherv(const void* send_buf,                      \
                                             size_t send_count,                         \
                                             void* recv_buf,                            \
                                             const size_t* recv_counts,                 \
                                             ccl_datatype_t dtype,                      \
...
{                                                                                       \
    return get_impl()->allgatherv_impl(send_buf, send_count, recv_buf, recv_counts,     \
                           dtype, attr, stream, deps);                                        \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t allreduce(const void* send_buf,                       \
                                            void* recv_buf,                             \
                                            size_t count,                               \
                                            ccl_datatype_t dtype,                       \
                                            ccl::reduction reduction,                   \
...
{                                                                                       \
    return get_impl()->allreduce_impl(send_buf, recv_buf, count, dtype,                 \
                          reduction, attr, stream, deps);                                     \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t alltoall(const void* send_buf,                        \
                                           void* recv_buf,                              \
                                           size_t count,                                \
                                           ccl_datatype_t dtype,                        \
                                           const ccl::alltoall_attr_t& attr,                  \
...
{                                                                                       \
    return get_impl()->alltoall_impl(send_buf, recv_buf, count,                         \
                         dtype, attr, stream, deps);                                          \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t alltoallv(const void* send_buf,                       \
                                            const size_t* send_counts,                  \
                                            void* recv_buf,                             \
                                            const size_t* recv_counts,                  \
                                            ccl_datatype_t dtype,                       \
...
{                                                                                       \
    return get_impl()->alltoallv_impl(send_buf, send_counts, recv_buf, recv_counts,     \
                          dtype, attr, stream, deps);                                         \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t bcast(void* buf,                                      \
                                        size_t count,                                   \
                                        ccl_datatype_t dtype,                           \
                                        size_t root,                                    \
                                        const ccl::bcast_attr_t& attr,                     \
...
{                                                                                       \
    return get_impl()->bcast_impl(buf, count, dtype, root, attr, stream, deps);               \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t reduce(const void* send_buf,                          \
                                         void* recv_buf,                                \
                                         size_t count,                                  \
                                         ccl_datatype_t dtype,                          \
                                         ccl::reduction reduction,                      \
...
#define DEVICE_COMM_INTERFACE_COLL_DEFINITION(type)                                            \
                                                                                        \
ccl::device_communicator::coll_request_t allgatherv(const type* send_buf,                      \
                                             size_t send_count,                         \
                                             type* recv_buf,                            \
                                             const size_t* recv_counts,                 \
                                             const ccl::allgatherv_attr_t& attr,                \
...
{                                                                                       \
    return get_impl()->allgatherv_impl(send_buf, send_count, recv_buf, recv_counts,     \
                           attr, stream, deps);                                               \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t allreduce(const type* send_buf,                       \
                                            type* recv_buf,                             \
                                            size_t count,                               \
                                            ccl::reduction reduction,                   \
                                            const ccl::allreduce_attr_t& attr,                 \
...
{                                                                                       \
    return get_impl()->allreduce_impl(send_buf, recv_buf,                               \
                                      count, reduction, attr, stream, deps);                  \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t alltoall(const type* send_buf,                        \
                                           type* recv_buf,                              \
                                           size_t count,                                \
                                           const ccl::alltoall_attr_t&* attr,                  \
                                           ccl::stream::impl_value_t& stream, \
...
{                                                                                       \
    return get_impl()->alltoall_impl(send_buf, recv_buf, count, attr, stream, deps);          \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t alltoallv(const type* send_buf,                       \
                                            const size_t* send_counts,                  \
                                            type* recv_buf,                             \
                                            const size_t* recv_counts,                  \
                                            const ccl::alltoallv_attr_t& attr,                 \
...
{                                                                                       \
    return get_impl()->alltoallv_impl(send_buf, send_counts, recv_buf, recv_counts,     \
                          attr, stream, deps);                                                \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t bcast(type* buf,                                      \
                                        size_t count,                                   \
                                        size_t root,                                    \
                                        const ccl::bcast_attr_t& attr,                     \
                                        ccl::stream::impl_value_t& stream,    \
...
{                                                                                       \
    return get_impl()->bcast_impl(buf, count, root, attr, stream, deps);                      \
                                                                                        ...
                                                                                        \
ccl::device_communicator::coll_request_t reduce(const type* send_buf,                          \
                                         type* recv_buf,                                \
                                         size_t count,                                  \
                                         ccl::reduction reduction,                      \
                                         size_t root,                                   \
...
ccl::device_communicator::coll_request_t allgatherv_impl(const void* send_buf,                 \
                                                  size_t send_count,                    \
                                                  void* recv_buf,                       \
                                                  const size_t* recv_counts,            \
                                                  ccl_datatype_t dtype,                 \
...
ccl::device_communicator::coll_request_t allgatherv_impl(const buffer_type* send_buf,          \
                                                  size_t send_count,                    \
                                                  ...
                                                  const ccl::vector_class<ccl::event>& dep);         \
                                                                                        \
                                                                                        \
ccl::device_communicator::coll_request_t allreduce_impl(const void* send_buf,                  \
                                                 void* recv_buf,                        \
                                                 size_t count,                          \
                                                 ccl_datatype_t dtype,                  \
                                                 ccl::reduction reduction,              \
...
ccl::device_communicator::coll_request_t allreduce_impl(const buffer_type* send_buf,           \
                                                 ...
                                                 const ccl::vector_class<ccl::event>& dep);          \
                                                                                        \
                                                                                        \
ccl::device_communicator::coll_request_t alltoall_impl(const void* send_buf,                   \
                                                void* recv_buf,                         \
                                                size_t count,                           \
                                                ccl_datatype_t dtype,                   \
                                                const ccl::alltoall_attr_t& attr,             \
                                                ...
                                                const ccl::vector_class<ccl::event>& dep);           \
template<class buffer_type>                                                             \
ccl::device_communicator::coll_request_t alltoall_impl(const buffer_type* send_buf,            \
                                                buffer_type* recv_buf,                  \
                                                size_t count,                           \
                                                const ccl::alltoall_attr_t& attr,             \
                                                ccl::stream::impl_value_t& stream,    \
                                                const ccl::vector_class<ccl::event>& dep);           \
                                                                                        \
                                                                                        \
ccl::device_communicator::coll_request_t alltoallv_impl(const void* send_buf,                  \
                                                 const size_t* send_counts,             \
                                                 void* recv_buf,                        \
                                                 const size_t* recv_counts,             \
                                                 ccl_datatype_t dtype,                  \
                                                 ...
                                                 const ccl::vector_class<ccl::event>& dep);          \
template<class buffer_type>                                                             \
ccl::device_communicator::coll_request_t alltoallv_impl(const buffer_type* send_buf,           \
                                                 const size_t* send_counts,             \
                                                 buffer_type* recv_buf,                 \
                                                 const size_t* recv_counts,             \
                                                 const ccl::alltoallv_attr_t& attr,            \
                                                 ...
                                                 const ccl::vector_class<ccl::event>& dep);          \
                                                                                        \
                                                                                        \
ccl::device_communicator::coll_request_t bcast_impl(void* buf,                                 \
                                             size_t count,                              \
                                             ccl_datatype_t dtype,                      \
                                             size_t root,                               \
                                             const ccl::bcast_attr_t& attr,                \
                                             ...
                                             const ccl::vector_class<ccl::event>& dep);              \
template<class buffer_type>                                                             \
ccl::device_communicator::coll_request_t bcast_impl(buffer_type* buf,                          \
                                             size_t count,                              \
                                             size_t root,                               \
                                             const ccl::bcast_attr_t& attr,                \
                                             ccl::stream::impl_value_t& stream,   \
                                              const ccl::vector_class<ccl::event>& dep);              \
                                                                                        \
                                                                                        \
ccl::device_communicator::coll_request_t reduce_impl(const void* send_buf,                     \
                                         void* recv_buf,                                \
                                         size_t count,                                  \
                                         ccl_datatype_t dtype,                          \
                                         ccl::reduction reduction,                      \
                                         ...
                                         const ccl::vector_class<ccl::event>& dep);                  \
template<class buffer_type>                                                             \
ccl::device_communicator::coll_request_t reduce_impl(const buffer_type* send_buf,              \
                                         buffer_type* recv_buf,                         \
                                         size_t count,                                  \
                                         ccl::reduction reduction,                      \
                                         size_t root,                                   \
...
sparse_allreduce_impl(const index_type& send_ind_buf, size_t send_ind_count,                    \
                      ...
                      value_type& recv_val_buf, size_t recv_val_count,                          \
                      ccl::reduction reduction,                                                 \
                      const ccl::sparse_allreduce_ \attr_t& attr,                                               \
                      ccl::stream::impl_value_t& stream,  \
                      const ccl::vector_class<ccl::event>& dep);
...
template ccl::device_communicator::coll_request_t                                  \
