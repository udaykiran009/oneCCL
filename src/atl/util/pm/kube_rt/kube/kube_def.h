...
#define KUBE_API_ADDR_ENV "CCL_KUBE_API_ADDR"
#define RANK_COUNT_ENV "CCL_RANK_COUNT"
#define ASK_ONLY_FRAMEWORK_ENV "CCL_ASK_FRAMEWORK"
...
#define KVS_LISTNER "CCL_LISTNER"
