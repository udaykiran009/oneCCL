...
atl_ep_t** atl_mpi::get_eps() {
    return ctx->eps;
}

atl_proc_coord_t* atl_mpi::get_proc_coord() {
    return &(ctx->coord);
}
...
atl_status_t atl_mpi::read(atl_ep_t* ep,
                           void* buf,
                           size_t len,
                           atl_mr_t* mr,
                           uint64_t addr,
...
atl_status_t atl_mpi::write(atl_ep_t* ep,
                            const void* buf,
                            size_t len,
                            atl_mr_t* mr,
                            uint64_t addr,
...
atl_status_t atl_mpi::wait_all(atl_ep_t* ep, atl_req_t* req, size_t count) {
