 ...
 */
__kernel void reduce_scatter_execution_float(size_t my_rank,
                                             size_t comm_size,
    ...
    for (size_t iter_idx = 0; iter_idx < comm_size - 1; ++iter_idx) {
        ...
        __global float4* right_buffer =
            (iter_idx == (comm_size - 2)) ? right_output_buffer : right_temp_buffer;
        size_t right_buffer_offset = (iter_idx == (comm_size - 2)) ? 0 : right_tmp_buffer_offset;
...
__kernel void reduce_scatter_execution_char(size_t my_rank,
                                            size_t comm_size,
                                            size_t elems_count,
...
__kernel void reduce_scatter_execution_int(size_t my_rank,
                                           size_t comm_size,
                                           size_t elems_count,
...
__kernel void reduce_scatter_execution_bfp16(size_t my_rank,
                                             size_t comm_size,
                                             size_t elems_count,
...
__kernel void reduce_scatter_execution_double(size_t my_rank,
                                              size_t comm_size,
                                              size_t elems_count,
...
__kernel void reduce_scatter_execution_int64_t(size_t my_rank,
                                               size_t comm_size,
                                               size_t elems_count,
...
__kernel void reduce_scatter_execution_uint64_t(size_t my_rank,
                                                size_t comm_size,
                                                size_t elems_count,
...
__kernel void reduce_scatter_execution_numa_bfp16(size_t my_rank,
                                                  size_t comm_size,
                                                  size_t elems_count,
                                                  const __global bfp16* input_buffer,
                                                  __global bfp16* output_buffer,
