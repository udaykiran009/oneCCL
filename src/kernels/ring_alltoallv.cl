...
DEFINE_KERNEL_NUMA(int8_t, char4)
DEFINE_KERNEL_NUMA(uint8_t, uchar4)

DEFINE_KERNEL_NUMA(int16_t, short4)
DEFINE_KERNEL_NUMA(uint16_t, ushort4)

DEFINE_KERNEL_NUMA(int32_t, int4)
DEFINE_KERNEL_NUMA(uint32_t, uint4)

DEFINE_KERNEL_NUMA(int64_t, long4)
DEFINE_KERNEL_NUMA(uint64_t, ulong4)

DEFINE_KERNEL_NUMA(float32_t, float4)
DEFINE_KERNEL_NUMA(float64_t, double4)
// TODO: implement support for missing types
//DEFINE_KERNEL(float16_t, half, 1)

DEFINE_KERNEL_NUMA(bf16, ushort)
