...
ccl::event single_device_communicator::allgatherv_base_impl(
    ...
    return allgatherv_base_impl(send_buf, send_count,
...
/* allreduce */
template <class buffer_type>
ccl::event single_device_communicator::allreduce_impl(
    const buffer_type* send_buf,
    buffer_type* recv_buf,
    size_t count,
    ...
    return allreduce_impl(send_buf, recv_buf, count,
                          ccl::native_type_info<buffer_type>::dtype,
...
ccl::event single_device_communicator::alltoall_impl(
    ...
    return alltoall_impl(send_buf, recv_buf, count,
                         ccl::native_type_info<buffer_type>::dtype,
                         stream, attr, deps);
}
...
ccl::event single_device_communicator::alltoallv_impl(
    ...
    return alltoallv_impl(send_buf, send_counts, recv_buf, recv_counts,
                          ccl::native_type_info<buffer_type>::dtype,
                          stream, attr, deps);
}
...
ccl::event single_device_communicator::broadcast_impl(
    ...
    return broadcast_impl(buf, count,
                          ccl::native_type_info<buffer_type>::dtype,
                          root,
                          stream, attr, deps);
}
...
/* reduce */
template <class buffer_type>
ccl::event single_device_communicator::reduce_impl(
    const buffer_type* send_buf,
    buffer_type* recv_buf,
    size_t count,
    ccl::reduction reduction,
    ...
    return reduce_impl(send_buf, recv_buf, count,
                       ccl::native_type_info<buffer_type>::dtype,
                       reduction, root,
                       stream, attr, deps);
}
...
ccl::event single_device_communicator::reduce_scatter_impl(
    ...
    return reduce_scatter_impl(send_buf, recv_buf, recv_count,
                               ccl::native_type_info<buffer_type>::dtype,
                               reduction,
                               stream, attr, deps);
}
...
ccl::event single_device_communicator::sparse_allreduce_impl(
    ...
    return sparse_allreduce_impl(send_ind_buf, send_ind_count,
