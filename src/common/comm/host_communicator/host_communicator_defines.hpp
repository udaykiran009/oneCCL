...
\
    template comm_class::coll_request_t comm_class::allgatherv_impl( \
        const type* send_buf, \
        size_t send_count, \
        type* recv_buf, \
...
\
    template comm_class::coll_request_t comm_class::alltoall_impl( \
        const vector_class<type*>& send_buf, \
        const vector_class<type*>& recv_buf, \
        size_t count, \
        const alltoall_attr& attr); \
\
    template comm_class::coll_request_t comm_class::alltoallv_impl( \
        const type* send_buf, \
...
\
    template comm_class::coll_request_t comm_class::alltoallv_impl( \
        const vector_class<type*>& send_bufs, \
        const vector_class<size_t>& send_counts, \
        const vector_class<type*>& recv_bufs, \
        const vector_class<size_t>& recv_counts, \
        const alltoallv_attr& attr); \
...
\
    template comm_class::coll_request_t comm_class::reduce_scatter_impl( \
        const type* send_buf, \
        type* recv_buf, \
        size_t recv_count, \
        ccl::reduction reduction, \
...
\
    template comm_class::coll_request_t comm_class::sparse_allreduce_impl( \
...
\
    template comm_class::coll_request_t CCL_API comm_class::alltoall( \
        ...
        const alltoall_attr& attr); \
\
    template comm_class::coll_request_t CCL_API comm_class::alltoallv( \
        const type* send_buf, \
        const vector_class<size_t>& send_counts, \
        type* recv_buf, \
        const vector_class<size_t>& recv_counts, \
...
\
    template comm_class::coll_request_t CCL_API comm_class::reduce(const type* send_buf, \
                                                                   ...
                                                                   const reduce_attr& attr); \
\
    template comm_class::coll_request_t CCL_API comm_class::reduce_scatter( \
        const type* send_buf, \
        type* recv_buf, \
        size_t recv_count, \
        ccl::reduction reduction, \
