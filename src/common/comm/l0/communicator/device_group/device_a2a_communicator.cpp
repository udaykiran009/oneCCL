...
/***********************************************************************/
//ALLREDUCE_EXPLICIT_INSTANTIATION(char);
//ALLREDUCE_EXPLICIT_INSTANTIATION(int);
//ALLREDUCE_EXPLICIT_INSTANTIATION(int64_t);
//ALLREDUCE_EXPLICIT_INSTANTIATION(uint64_t);
ALLREDUCE_EXPLICIT_INSTANTIATION(device_group_a2a_communicator, float);
//ALLREDUCE_EXPLICIT_INSTANTIATION(double);
