...
class thread_device_group_a2a_communicator :
        public typed_base_communicator<ccl::device_topology_type::a2a_thread_group>
{
public:
    using base_t = typed_base_communicator<ccl::device_topology_type::a2a_thread_group>;
