                ...
                switch (class_id)
                {
                    case ccl::device_topology_type::ring:
                    {
                        const auto& original_rank =
                                inprocess_gpu_comm.template get_comm_data<
...
*/
    ...
    {
        return inprocess_gpu_comm.template get_gpu_kernel<module_type,
                                                          group_id,
                                                          class_id,
                                                          native_data_type>();
    }
    ...
    {
        const topology_addr<group_id, class_id> &comm_addr = base::template get_comm_data<group_id, class_id>();
