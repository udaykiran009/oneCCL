...
class ccl_scaleout_proxy : public ccl_gpu_base_comm<ccl_scaleout_proxy<device_t>,
...
public:
    ...
    using gpu_module_t = typename device_t::template gpu_module_t<algo_type,
                                                                  group_id,
    ...
    using gpu_kernel_t = typename gpu_module_t<algo_type, group_id, class_id>::template kernel<native_data_type>;
    ...
    ccl_scaleout_proxy(ccl_device& assigned_device, typename base::comm_rank_t idx,
    ...
    gpu_kernel_t<module_type, group_id, class_id, native_data_type>& get_gpu_kernel()
    {
        ...
        return wrapped_gpu_comm.template get_gpu_kernel<module_type,
                                                        group_id,
                                                        class_id,
                                                        native_data_type>();
    }
...
public:
    ...
    template<ccl_coll_type algo_type,
             ...
             ccl::device_topology_type class_id,
             class native_data_type>
    using gpu_kernel_t = typename gpu_module_t<algo_type,
                                               group_id,
                                               class_id>::template kernel<native_data_type>;
...
class ccl_scaleout_proxy<ccl_gpu_scaleup_proxy<ccl_numa_proxy<device_t>>> :
                public ccl_gpu_base_comm<ccl_scaleout_proxy<ccl_gpu_scaleup_proxy<ccl_numa_proxy<device_t>>>,
                                        gpu_types::MIX_UNIVERSAL_TYPES + device_t::type_idx()>,
                public proxy_observer_specific<ccl_scaleout_proxy<ccl_gpu_scaleup_proxy<ccl_numa_proxy<device_t>>>>
{
public:
    using base = ccl_gpu_base_comm<ccl_scaleout_proxy<ccl_gpu_scaleup_proxy<ccl_numa_proxy<device_t>>>,
                                   gpu_types::MIX_UNIVERSAL_TYPES + device_t::type_idx()>;
    using typename base::comm_rank_t;
    ...
    using proxy_base =
                proxy_observer_specific<ccl_scaleout_proxy<ccl_gpu_scaleup_proxy<ccl_numa_proxy<device_t>>>>;
