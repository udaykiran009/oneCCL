...
namespace native
{
#define TEMPLATE_DECL_ARG       ccl::device_group_split_type group_id, ccl::device_topology_type ...class_id
...
void device_community_container<class_id>::register_device_by_id(const ccl::device_index_type& device_id,
...
template<ccl::device_group_split_type group_id>
void device_community_container<ccl::device_topology_type::ring>::register_device_by_id(const ccl::device_index_type& device_id, ccl::context_comm_addr& registered_addr)
{
...
void
device_group_community_holder<TEMPLATE_DEF_ARG>::register_device_by_id(
