...
template<TEMPLATE_DECL_ARG>
void scale_up_ctx<TEMPLATE_DEF_ARG>::invoke_ctx_observer(observer_t<ccl_gpu_comm>* observer_ptr,
...
template<TEMPLATE_DECL_ARG>
void scale_up_ctx<TEMPLATE_DEF_ARG>::invoke_ctx_observer(observer_t<ccl_virtual_gpu_comm>* observer_ptr,
                                       std::integral_constant<ccl::device_topology_type,
                                                              ccl::device_topology_type::ring> val)
{
    throw std::runtime_error(std::string("Valid proxy: ") + observer_ptr->to_string());
