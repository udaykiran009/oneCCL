...
{
    using scaling_context_base = numa_ctx<thread_group_context, SUPPORTED_TOPOLOGY_CLASSES_DECL_LIST>;
    ...
    using topologies =
            device_group_community_holder<ccl::device_group_split_type::process,
