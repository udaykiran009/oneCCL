...
public:
    ...
    void attach(device_t* obj)
    {
        ...
        get_this()->attach_ctx_observer(obj,
    ...
    void invoke_proxy(device_t* obj, Args&&...args)
    {
        ...
        get_this()->invoke_ctx_observer(obj,
                                        std::integral_constant<ccl::device_group_split_type,
                                                               group_id> {},
                                        std::forward<Args>(args)...);
    }

    // helpers
    template<ccl::device_topology_type specific_type,
             ccl::device_topology_type ...class_id>
    static observables_types<specific_type>& get_types(observable_topologies<class_id...>& tops) noexcept
    {
    ...
    container_t<observer_device_t>& get_container(observables_types<specific_type>& types) noexcept
    {
    ...
    template<class observer_device_t,
             ...
             ccl::device_topology_type ...class_id>
    container_t<observer_device_t>& get_types_container(observable_topologies<class_id...>& tops) noexcept
    {
