...
struct ring_reduce_scatter_kernel
        : public execution_kernel<
              ring_reduce_scatter_kernel<native_type>,
              arg<main_kernel_args::args_start_index, size_t>, // recv_count
              arg<main_kernel_args::args_start_index + 1, native_type*>, // send_buf
              arg<main_kernel_args::args_start_index + 2, native_type*>, // recv_buf
              external_arg<main_kernel_args::args_start_index + 3, native_type*>, // tmp_buf
    ...
    using base = execution_kernel<ring_reduce_scatter_kernel<native_type>,
                                  send_buf_size_arg,
                                  send_buf_arg,
                                  recv_buf_arg,
                                  tmp_recv_buf_arg,
...
struct ring_reduce_scatter_numa_kernel
        : public execution_kernel<
              ring_reduce_scatter_numa_kernel<native_type>,
...
*/
    ...
    using base = execution_kernel<ring_reduce_scatter_numa_kernel<native_type>,
                                  send_buf_size_arg,
                                  send_buf_arg,
                                  recv_buf_arg,
                                  tmp_recv_buf_arg,
...
struct ring_reduce_scatter_ipc
        : public ipc_kernel<ring_reduce_scatter_ipc<native_type>,
    ...
    using tmp_recv_buf_arg = typename ring_reduce_scatter_kernel<native_type>::tmp_recv_buf_arg;
    using tmp_recv_buf_arg_type = typename tmp_recv_buf_arg::arg_type;

    using income_data_flag_arg =
        typename ring_reduce_scatter_kernel<native_type>::income_data_flag_arg;
    using income_data_flag_arg_type = typename income_data_flag_arg::arg_type;

    using ready_to_recv_flag_arg =
        typename ring_reduce_scatter_kernel<native_type>::ready_to_recv_flag_arg;
    using ready_to_recv_flag_arg_type = typename ready_to_recv_flag_arg::arg_type;

    using base = execution_kernel<ring_reduce_scatter_ipc<native_type>,
                                  stub_arg<main_kernel_args::args_start_index>,
                                  stub_arg<main_kernel_args::args_start_index + 1>,
                                  stub_arg<main_kernel_args::args_start_index + 2>,
                                  tmp_recv_buf_arg,
