...
struct ring_allreduce_kernel
        : public execution_kernel<
              ...
              thread_safe_arg<main_kernel_args::args_start_index + 3,
                              native_type*,
                              options::uncached>,
              thread_safe_arg<main_kernel_args::args_start_index + 4, int*, options::uncached>,
              thread_safe_arg<main_kernel_args::args_start_index + 5, int*, options::uncached>,
    ...
    using tmp_recv_buf_arg = thread_safe_arg<main_kernel_args::args_start_index + 3,
                                             processing_type*,
                                             options::uncached>;
