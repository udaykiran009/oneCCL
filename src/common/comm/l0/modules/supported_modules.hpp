...
template<template<ccl_coll_type,
...
using topology_device_classes_modules_for_group_id =
                        std::tuple<std::shared_ptr<module_impl<type,
                                                               group_id,
                                                               class_ids>>...>;
...
using topology_device_group_modules =
                        std::tuple<topology_device_classes_modules_for_group_id<
                                            module_impl,
                                            type,
                                            top_types,
...
template<template<ccl_coll_type,
                  ...
                  ccl::device_topology_type> class module_impl,
         ccl_coll_type... types>
using supported_topology_device_modules =
                        std::tuple<topology_device_group_modules<
                                        module_impl,
                                        types,
