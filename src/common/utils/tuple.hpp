...
void ccl_tuple_for_each_args_impl(specific_tuple&& t, functor f, std::true_type tuple_finished, args_t&&...args) {
    // nothing to do
}

template <class specific_tuple, class functor, size_t cur_index, class ...args_t>
void ccl_tuple_for_each_args_impl(specific_tuple&& t, functor f, std::false_type tuple_not_finished, args_t&&...args) {
...
struct is_one_of<T, Front, Others...>:
    public std::conditional<std::is_same<T, Front>::value,
                            std::true_type,
