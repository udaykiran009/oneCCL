...
using device_group_split_type_names = utils::enum_to_str<static_cast<typename std::underlying_type<ccl::device_group_split_type>::type>(ccl::device_group_split_type::last_value)>;
