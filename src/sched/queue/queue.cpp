...
ccl_sched_queue::ccl_sched_queue(size_t idx, std::vector<size_t> atl_eps) : idx(idx), atl_eps(atl_eps) {
    LOG_DEBUG("created sched_queue, idx ", idx, ", atl_eps count ", atl_eps.size(), ", atl_eps[0] ", atl_eps[0]);
