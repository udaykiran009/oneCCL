...
class base_gpu_bcast_entry : public sched_entry {
public:
    using gpu_comm = gpu_comm_impl;
    using processing_type = native_type;
    using kernel_main_typed = ring_bcast_kernel<processing_type>;
    ...
    base_gpu_bcast_entry() = delete;
    base_gpu_bcast_entry(ccl_sched *sched,
    ...
    virtual void start() override {
        ...
        auto buf_ptr = reinterpret_cast<native_type *>(buf.get_ptr());

        main_entry_function.template set_arg<typename kernel_main_typed::buf_size_arg>(elem_count);
        main_entry_function.template set_arg<typename kernel_main_typed::buf_arg>(buf_ptr);
        main_entry_function.template set_arg<typename kernel_main_typed::root_arg>(root);
