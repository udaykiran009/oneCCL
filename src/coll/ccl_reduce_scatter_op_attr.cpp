...
ccl_reduce_scatter_attr_impl_t::ccl_reduce_scatter_attr_impl_t(const typename ccl_operation_attr_impl_t::version_traits_t::type& version) :
        base_t(version)
{
}

typename ccl_reduce_scatter_attr_impl_t::reduction_fn_traits_t::return_type
ccl_reduce_scatter_attr_impl_t::set_attribute_value(typename reduction_fn_traits_t::type val, const reduction_fn_traits_t&t)
{
