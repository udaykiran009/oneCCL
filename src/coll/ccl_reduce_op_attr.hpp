...
class ccl_reduce_attr_impl_t : public ccl_common_op_attr_impl_t
{
public:
    using base_t = ccl_common_op_attr_impl_t;

    ccl_reduce_attr_impl_t(const typename details::ccl_api_type_attr_traits<operation_attr_id, ccl::operation_attr_id::version>::type& version);

    using reduction_fn_traits_t = details::ccl_api_type_attr_traits<reduce_attr_id, reduce_attr_id::reduction_fn>;
