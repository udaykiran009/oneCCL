...
ccl_sparse_allreduce_attr_impl_t::set_attribute_value(typename sparse_allreduce_completion_fn_traits::type val, const sparse_allreduce_completion_fn_traits&t)
{
...
ccl_sparse_allreduce_attr_impl_t::get_attribute_value(const sparse_allreduce_completion_fn_traits& id) const
{
...
ccl_sparse_allreduce_attr_impl_t::set_attribute_value(typename sparse_allreduce_alloc_fn_traits::type val, const sparse_allreduce_alloc_fn_traits&t)
{
...
ccl_sparse_allreduce_attr_impl_t::get_attribute_value(const sparse_allreduce_alloc_fn_traits& id) const
{
    return alloc_fn_val;
}
...
ccl_sparse_allreduce_attr_impl_t::set_attribute_value(typename sparse_allreduce_fn_ctx_traits::type val, const sparse_allreduce_fn_ctx_traits&t)
{
    auto old = fn_ctx_val;
...
ccl_sparse_allreduce_attr_impl_t::get_attribute_value(const sparse_allreduce_fn_ctx_traits& id) const
{
    return fn_ctx_val;
}
...
ccl_sparse_allreduce_attr_impl_t::set_attribute_value(typename sparse_coalesce_mode_traits::type val, const sparse_coalesce_mode_traits&t)
{
    auto old = mode_val;
