...
ccl_operation_attr_impl_t::set_attribute_value(typename version_traits_t::type val, const version_traits_t& t)
{
    (void)t;
...
ccl_operation_attr_impl_t::set_attribute_value(typename prologue_fn_traits_t::type val, const prologue_fn_traits_t& t)
{
...
ccl_operation_attr_impl_t::set_attribute_value(typename epilogue_fn_traits_t::type val, const epilogue_fn_traits_t& t)
{
...
ccl_operation_attr_impl_t::set_attribute_value(typename priority_traits_t::type val, const priority_traits_t& t)
{
    auto old = priority;
...
ccl_operation_attr_impl_t::set_attribute_value(typename synchronous_traits_t::type val, const synchronous_traits_t& t)
{
...
ccl_operation_attr_impl_t::set_attribute_value(typename to_cache_traits_t::type val, const to_cache_traits_t& t)
{
    auto old = to_cache;
...
ccl_operation_attr_impl_t::set_attribute_value(typename match_id_traits_t::type val, const match_id_traits_t& t)
{
    auto old = match_id;
