...
CCL_API allgatherv_attr_t default_allgatherv_attr = ccl_empty_attr::create_empty<allgatherv_attr_t>();
...
CCL_API barrier_attr_t default_barrier_attr = ccl_empty_attr::create_empty<barrier_attr_t>();
...
CCL_API sparse_allreduce_attr_t default_sparse_allreduce_attr = ccl_empty_attr::create_empty<sparse_allreduce_attr_t>();
