...
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(char);
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(int);
...
#define COMMA ,
#endif
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(cl::sycl::buffer<char COMMA 1>);
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(cl::sycl::buffer<int COMMA 1>);
...
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(char, char);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(char, int);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(char, ccl::bf16);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(char, float);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(char, double);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(char, int64_t);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(char, uint64_t);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int, char);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int, int);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int, ccl::bf16);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int, float);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int, double);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int, int64_t);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int, uint64_t);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int64_t, char);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int64_t, int);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int64_t, ccl::bf16);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int64_t, float);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int64_t, double);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int64_t, int64_t);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(int64_t, uint64_t);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(uint64_t, char);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(uint64_t, int);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(uint64_t, ccl::bf16);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(uint64_t, float);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(uint64_t, double);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(uint64_t, int64_t);
API_COMM_SPARSE_OP_PTR_EXPLICIT_INSTANTIATION(uint64_t, uint64_t);

// #ifdef CCL_ENABLE_SYCL
// #ifndef COMMA
// #define COMMA ,
// #endif
// API_COMM_SPARSE_OP_REF_EXPLICIT_INSTANTIATION(cl::sycl::buffer<int COMMA 1>,
