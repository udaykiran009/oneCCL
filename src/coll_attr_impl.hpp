...
{
    return static_cast<ccl_operation_attr_impl_t*>(get_impl().get())->set_attribute_value(v, details::ccl_api_type_attr_traits<operation_attr_id, attrId> {});
}
...
{
    return static_cast<const ccl_operation_attr_impl_t*>(get_impl().get())->get_attribute_value(details::ccl_api_type_attr_traits<operation_attr_id, attrId>{});
}
