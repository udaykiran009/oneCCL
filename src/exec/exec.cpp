...
mlsl_status_t mlsl_executor_create(size_t worker_count, size_t priority_count, mlsl_executor **executor)
{
    ...
    mlsl_executor *e = static_cast<mlsl_executor*>(MLSL_CALLOC(sizeof(mlsl_executor), "executor"));
    e->worker_count = worker_count;
    e->workers = static_cast<mlsl_worker**>(MLSL_CALLOC(sizeof(mlsl_worker*) * worker_count, "executor->workers"));
    ...
    atl_comm_t **comms = static_cast<atl_comm_t**>(MLSL_CALLOC(sizeof(atl_comm_t *) * total_comm_count, "comms"));
