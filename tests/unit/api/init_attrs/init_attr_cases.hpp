...
TEST(init_attr, init_attr_empty_creation) {
    ccl::init_attr attr = ccl::default_init_attr;
    ASSERT_TRUE(attr.get<ccl::init_attr_id::version>().full != nullptr);
}

TEST(init_attr, copy_init_attr) {
    auto attr = ccl::default_init_attr;
    ...
    ASSERT_TRUE(attr2.get<ccl::init_attr_id::version>().full != nullptr);
}

TEST(init_attr, move_init_attr) {
    /* move constructor test */
    auto orig_attr = ccl::default_init_attr;
    ...
    auto orig_attr2 = ccl::default_init_attr;

    auto moved_attr2 = ccl::default_init_attr;
