...
device_group_a2a_communicator::coll_request_t
device_group_a2a_communicator::barrier(ccl::stream::impl_value_t& stream,
...
/* allgatherv */
device_group_a2a_communicator::coll_request_t
device_group_a2a_communicator::allgatherv_impl(
    const void* send_buf,
    size_t send_count,
    void* recv_buf,
...
/* allreduce */
device_group_a2a_communicator::coll_request_t
device_group_a2a_communicator::allreduce_impl(
    const void* send_buf,
    void* recv_buf,
    size_t count,
    ccl::datatype dtype,
...
/* alltoall */
device_group_a2a_communicator::coll_request_t
device_group_a2a_communicator::alltoall_impl(
    const void* send_buf,
    void* recv_buf,
    size_t count,
    ccl::datatype dtype,
...
/* alltoallv */
device_group_a2a_communicator::coll_request_t
device_group_a2a_communicator::alltoallv_impl(
    const void* send_buf,
...
/* bcast */
device_group_a2a_communicator::coll_request_t
device_group_a2a_communicator::broadcast_impl(
    void* buf,
    size_t count,
    ccl::datatype dtype,
    size_t root,
...
/* reduce */
device_group_a2a_communicator::coll_request_t
device_group_a2a_communicator::reduce_impl(
    const void* send_buf,
    void* recv_buf,
    size_t count,
    ccl::datatype dtype,
...
/* reduce_scatter */
device_group_a2a_communicator::coll_request_t
device_group_a2a_communicator::reduce_scatter_impl(
    const void* send_buf,
    void* recv_buf,
    size_t recv_count,
    ccl::datatype dtype,
...
device_group_a2a_communicator::coll_request_t
device_group_ring_communicator::barrier(ccl::stream::impl_value_t& stream,
                                                       const ccl::barrier_attr& attr,
                                                       const ccl::vector_class<ccl::event>& deps) {
    return {};
}
...
/* allgatherv */
device_group_a2a_communicator::coll_request_t
device_group_ring_communicator::allgatherv_impl(
    const void* send_buf,
    size_t send_count,
    void* recv_buf,
    const ccl::vector_class<size_t>& recv_counts,
...
/* allreduce */
device_group_a2a_communicator::coll_request_t
device_group_ring_communicator::allreduce_impl(
    const void* send_buf,
    void* recv_buf,
    size_t count,
    ccl::datatype dtype,
...
/* alltoall */
device_group_a2a_communicator::coll_request_t
device_group_ring_communicator::alltoall_impl(
    const void* send_buf,
    void* recv_buf,
    size_t count,
    ccl::datatype dtype,
...
/* alltoallv */
device_group_a2a_communicator::coll_request_t
device_group_ring_communicator::alltoallv_impl(
    const void* send_buf,
    const ccl::vector_class<size_t>& send_counts,
    void* recv_buf,
    const ccl::vector_class<size_t>& recv_counts,
...
/* bcast */
device_group_a2a_communicator::coll_request_t
device_group_ring_communicator::broadcast_impl(
    void* buf,
    size_t count,
    ccl::datatype dtype,
    size_t root,
...
/* reduce */
device_group_a2a_communicator::coll_request_t
device_group_ring_communicator::reduce_impl(
    const void* send_buf,
    void* recv_buf,
    size_t count,
    ccl::datatype dtype,
...
/* reduce_scatter */
device_group_a2a_communicator::coll_request_t
device_group_ring_communicator::reduce_scatter_impl(
    const void* send_buf,
    void* recv_buf,
    size_t recv_count,
    ccl::datatype dtype,
