...
TEST_F(router_fixture, SCALEUP_TEST_3_process_3_devices_process_0) {
    ...
    constexpr ccl::group_split_type topology = ccl::group_split_type::cluster;
    {
        process_creator_params params = prepare_process_params(
            ...
            { { process_index, { dev_0 } }, { 1, { dev_1 } }, { 2, { dev_2 } } });

        adjacency_matrix expected_matrix{ { dev_0, { { dev_0, 1 }, { dev_1, 0 }, { dev_2, 0 } } },
                                          { dev_1, { { dev_0, 0 }, { dev_1, 1 }, { dev_2, 0 } } },
                                          { dev_2, { { dev_0, 0 }, { dev_1, 0 }, { dev_2, 1 } } } };
        ...
        top.set_mock_colored_cluster_graphs_to_merge({
            //to_check
            { process_index, { { { process_index, dev_0 } } } },
...
TEST_F(router_fixture, SCALEUP_TEST_3_process_3_devices_process_1) {
    using namespace utils;
    using namespace native;
    using namespace native::detail;
    ...
    constexpr ccl::group_split_type topology = ccl::group_split_type::cluster;
    {
        process_creator_params params = prepare_process_params(
            ...
            { { 0, { dev_0 } }, { process_index, { dev_1 } }, { 2, { dev_2 } } });
        ...
        std::vector<expected_indices_tuple> expected_thread_results;
        set_control_indices<ccl_scaleout_proxy<ccl_gpu_comm>>(
            expected_thread_results, 0, optional_indices{ true, { 1 }, { 0 } });
        std::tie(res, descr) = check_ring_multiple_topologies<topology,
                                                              ccl::device_topology_type::ring,
                                                              process_group_context>(
            pg_comm->process_device_topology, params.thread_ids, expected_thread_results, true, 0);
...
TEST_F(router_fixture, SCALEUP_TEST_3_process_3_devices_process_2) {
    using namespace utils;
    using namespace native;
    using namespace native::detail;
    ...
    constexpr ccl::group_split_type topology = ccl::group_split_type::cluster;
    {
        process_creator_params params = prepare_process_params(
            ...
            { { 0, { dev_0 } }, { 1, { dev_1 } }, { process_index, { dev_2 } } });
        ...
        top.set_mock_colored_cluster_graphs_to_merge({
            ...
            { 0, { { { 0, dev_0 } } } },
            { 1, { { { 1, dev_1 } } } },
            { process_index, { { { process_index, dev_2 } } } },
        });
...
TEST_F(router_fixture, SCALEUP_TEST_3_process_6_devices_process_0) {
    using namespace utils;
    using namespace native;
    using namespace native::detail;
...
TEST_F(router_fixture, SCALEUP_TEST_3_process_6_devices_process_1) {
    using namespace utils;
    using namespace native;
    using namespace native::detail;
...
TEST_F(router_fixture, SCALEUP_TEST_3_process_6_devices_process_2) {
    using namespace utils;
    using namespace native;
    using namespace native::detail;
    ...
    constexpr ccl::group_split_type topology = ccl::group_split_type::cluster;
    {
        process_creator_params params = prepare_process_params(
            ...
            { { 0, { dev_0, dev_1 } }, { 1, { dev_2, dev_3 } }, { 2, { dev_4, dev_5 } } });
        ...
        top.set_mock_colored_cluster_graphs_to_merge({
            ...
            { 1, { { { 1, dev_2 }, { 1, dev_3 } } } },
            { process_index, { { { process_index, dev_4 }, { process_index, dev_5 } } } },
        });
