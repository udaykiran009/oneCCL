...
class ring_alltoallv_single_device_fixture : public common_fixture {
protected:
    ring_alltoallv_single_device_fixture()
...
class ring_alltoallv_multi_device_fixture : public common_fixture {
protected:
    ring_alltoallv_multi_device_fixture()
...
template <class DType>
class ring_alltoallv_single_device_multi_tile_fixture : public common_fixture {
protected:
    ring_alltoallv_single_device_multi_tile_fixture()
