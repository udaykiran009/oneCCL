...
TEST_F(router_fixture, cluster_simple_scaleup_test)
{
...

    {
        ...
        native::details::p2p_rating_function rating_function = std::bind(utils::test_custom_p2p_ping,
                                                                         std::placeholders::_1,
                                                                         std::placeholders::_2,
                                                                         expected_matrix);
        ...
        adjacency_matrix matrix =
                cluster_group_device_creator::build_p2p_capability_matrix(ss,
                                                                          params.total_node_mask,rating_function);
        //check matrix
        ...
        try
        {
            ...
            res = top.build_all(ss, comm_addr, tg_comm->per_thread_indices, matrix, rating_function);
        }
        ...
        std::tie(res, descr) =
                        check_ring_multiple_topologies<topology, class_id,
                                                  process_group_context>(pg_comm->process_device_topology,
                                                                         params.thread_ids, expected_seq);
        if (!res)
        {
            output << "\nLOG:\n" << ss.str() << std::endl;
            output << descr;
...
TEST_F(router_fixture, cluster_simple_scaleup_scaleout_test)
{
...

    {
        ...
        adjacency_matrix expected_matrix
                                        {
                                            { dev_0,
                                                    {{dev_0, 1}, {dev_1, 1}, {dev_2, 1}, {dev_3, 1}}},
                                            { dev_1,
                                                    {{dev_0, 1}, {dev_1, 1}, {dev_2, 1}, {dev_3, 1}}},
                                            { dev_2,
                                                    {{dev_0, 1}, {dev_1, 1}, {dev_2, 1}, {dev_3, 1}}},
...
TEST_F(router_fixture, cluster_numa_scaleup_test)
{
...

    {
        ...
        adjacency_matrix expected_matrix
                                        {
                                            ...
                                            { dev_2,
                                                    {{dev_0, 1}, {dev_1, 1}, {dev_2, 1},
                                                     {dev_3, 0}, {dev_4, 0}, {dev_5, 0}}},
                                            { dev_3,
                                                    {{dev_0, 0}, {dev_1, 0}, {dev_2, 0},
                                                     {dev_3, 1}, {dev_4, 1}, {dev_5, 1}}},
                                            { dev_4,
                                                    {{dev_0, 0}, {dev_1, 0}, {dev_2, 0},
                                                     {dev_3, 1}, {dev_4, 1}, {dev_5, 1}}},
                                            { dev_5,
        ...
        set_control_indices<ccl_gpu_comm>(
                            expected_seq, 0, optional_indices{true, {4}, {1}});
                            ...
                            {process_index,
                                {
                                    ...
                                    { {process_index, dev_3}, {process_index, dev_4}, {process_index, dev_5}}
                                },
                            },
                            {2,
                                {
