...
template <class DType>
class ring_reduce_scatter_multi_device_fixture : public common_fixture {
protected:
    ring_reduce_scatter_multi_device_fixture()
...
template <class DType>
class ring_reduce_scatter_single_device_multi_tile_fixture : public common_fixture {
protected:
    ring_reduce_scatter_single_device_multi_tile_fixture()
