...
class ring_allgatherv_multi_device_fixture : public common_fixture {
protected:
    ring_allgatherv_multi_device_fixture()
...
template <class DType>
class ring_allgatherv_single_device_multi_tile_fixture : public common_fixture {
protected:
    ring_allgatherv_single_device_multi_tile_fixture()
