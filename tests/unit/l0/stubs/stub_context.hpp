...
struct process_context : public native::process_group_context
{
    ...
    // stubs override
    void collect_cluster_colored_plain_graphs(const native::details::colored_plain_graph_list& send_graph,
                                              native::details::global_sorted_colored_plain_graphs& received_graphs) override
    {
        ...
        native::process_group_context::collect_cluster_colored_plain_graphs(send_graph, received_graphs);
    }
