...
class datatype_attr_t : public ccl_api_base_copyable<datatype_attr_t, copy_on_write_access_policy, ccl_datatype_attr_impl>
{
public:
    using base_t = ccl_api_base_copyable<datatype_attr_t, copy_on_write_access_policy, ccl_datatype_attr_impl>;
    ...
    datatype_attr_t& operator=(const datatype_attr_t& src);
    datatype_attr_t& operator=(datatype_attr_t&& src);
    datatype_attr_t(datatype_attr_t&& src);
    datatype_attr_t(const datatype_attr_t& src);
    ~datatype_attr_t() noexcept;
...
private:
    ...
    datatype_attr_t(const typename details::ccl_api_type_attr_traits<ccl_datatype_attributes, ccl_datatype_attributes::version>::return_type& version);
};
