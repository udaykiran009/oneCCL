...
int main(int argc, char** argv) {
    ...
    register_gpu_module_source(
        "kernels/ring_allreduce.spv", ccl_topology_class_t::ring_algo_class, ccl_coll_allreduce);
    register_gpu_module_source(
        "kernels/a2a_allreduce.spv", ccl_topology_class_t::ring_algo_class, ccl_coll_allreduce);
